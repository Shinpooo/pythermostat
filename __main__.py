...
if  __name__ == "__main__":
    ...
    test_end_date = isoparse("2020-01-20T00:00:00")
    ...
    result_folder = "results/" + test_env.start_date.strftime("%m-%d-%Y") + "_to_" + test_env.end_date.strftime("%m-%d-%Y")
    test_env.store_and_plot(result_folder)
